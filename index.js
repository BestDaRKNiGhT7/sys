...
client.on("ready", () => {
    var guild;
    while (!guild)
        guild = client.guilds.get("526511946355179521")
...
client.on("guildMemberAdd", (member) => {
    let channel = member.guild.channels.find('name', "mars");
    if (!channel) {
        ...
        data.forEach((Invite, key, map) => {
            ...
            if (dat[Inv])
                if (dat[Inv] < Invite.uses) {
                    console.log(3);
 channel.send(`**Welcome To The Server** :gem: \n Have a Nice Time 🎶 \n ${member} Invited By ${Invite.inviter}`)
 }
            dat[Inv] = Invite.uses;
        })
    })
...
client.on('ready', function(){
    ...
    var ms = 100000 ;
    var setGame = [`-help On ${client.guilds.size} Servers`,`The Top Users ${client.users.size}`,`Mars ❤ ✯`];
    var i = -1;
    var j = 0;
...
client.on("message", message => {
 if (message.content === "-invvvvvv") {
  const embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .setFooter('©Mars')
      .addField('Mars', `https://discordapp.com/oauth2/authorize?client_id=469477937104551956&scope=bot&permissions=8`)
...
client.on('message', message => {
  ...
  .setFooter(`<@279221610408312834>`, 'https://images-ext-2.discordapp.net/external/X9SanEG0s7Dtv3krTgy-kod_fj6JRVJ2AG4JryCiiz0/%3Fsize%3D2048/https/cdn.discordapp.com/avatars/375761288518828042/fffa31c797e88cf059dd6db424ff456a.png?width=80&height=80')
  .setColor("#000000")
  .addField("Done | تــــم" , ":envelope: | Check Your DM ")
...
client.on("message", message => {
      if (message.content === "-support") {
       const embed = new Discord.RichEmbed()
           .setColor("RANDOM")
           .setFooter('©Mars')  
           .addField('❤سيرفر الدعم الفني', `  https://discord.gg/PjtgPck  `)
       message.author.send({embed});
...
client.on('message', async message => {
  ...
  if(message.content.startsWith(prefix + "mute")) {
    ...
    .setTitle('تم اعطائك ميوت في السيرفر')
...
client.on("guildMemberAdd", member => {
      const welcomer =  member.guild.channels.find('name', 'mars');
...
client.on('message', message => {
 ...
 client.on('message', async message => {
  if(message.content.startsWith(prefix + "allbc")) {
    ...
    if(message.author.id !== '279221610408312834') return message.channel.send('❎ » هذا الأمر مخصص لصاحب البوت فقط');
