...
client.on('ready', function(){
    ...
    var ms = 100000 ;
    var setGame = [`-help On ${client.guilds.size} Servers`,`-inv Users ${client.users.size}`,`zCodes ❤ ✯`];
    var i = -1;
    var j = 0;
...
client.on("message", message => {
 if (message.content === "-inv") {
  const embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .setFooter('©zCodes')
      .addField('zCodes', `https://discordapp.com/oauth2/authorize?client_id=469477937104551956&scope=bot&permissions=8`)
