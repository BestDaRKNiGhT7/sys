...
client.on('message', message => {
  ...
  if (message.author.id !== "471466551720280066") return;
...
client.on("message", (message) => {
  ...
  if (message.content.toLowerCase().startsWith(prefix + `ticket`)) {
    ...
    .setTitle(`:mailbox_with_mail: Slayers`)
    .setColor(0xCF40FA)
    .setDescription(`Hello! I'm the Slayer, the Discord bot for super cool support ticket stuff and more! Here are my commands:`)
    .addField(`Tickets`, `[${prefix}new]() > Opens up a new ticket and tags the Support Team\n[${prefix}close]() > Closes a ticket that has been resolved or been opened by accident`)
    .addField(`Other`, `[${prefix}help]() > Shows you this help menu your reading\n[${prefix}ping]() > Pings the bot to see how long it takes to react\n[${prefix}about]() > Tells you all about Slayer`)
...
if (message.content.toLowerCase().startsWith(prefix + `new`)) {
    ...
    message.guild.createChannel(`ticket-${message.author.id}`, "text").then(c => {
        ...
        message.channel.send(`:white_check_mark: تم انشاء التيكيت #${c.name}.`);
        const embed = new Discord.RichEmbed()
        .setColor(0xCF40FA)
        .addField(`Hey ${message.author.username}!`, `من فضلك اكتب سبب انشاء التيكيت.`)
        .setTimestamp();
        c.send({ embed: embed });
    }).catch(console.error);
}
