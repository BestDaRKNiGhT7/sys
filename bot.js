...
client.on("message", (message) => {
  ...
  if (message.content.startsWith("tclose")) {
       ...
       message.channel.send(`هل انت متأكد من اقفالك للتذكرة اذا متأكد اكتب tconfirm`)
           .then((m) => {
...
client.on('message',async message => {
  ...
  if(message.content.startsWith(prefix + "giveaway")) {
    ...
    message.channel.send(`:eight_pointed_black_star:| **اكتب اسم الروم الذي تريد به القيف اواي**`).then(msg => {
