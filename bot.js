...
client.user.setGame(`Tops | *help`,"http://twitch.tv/Death Shop")
...
message.channel.send(`**banned from the server**`)
...
client.login(process.env.NDcxNDY2NTUxNzIwMjgwMDY2.DsYo9A.dz_HCFJQTNxq55I9SQnWDG8vfFk);// تبي تهكر البوت اقول انقلع بس لووول
